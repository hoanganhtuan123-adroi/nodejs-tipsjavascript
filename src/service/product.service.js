...
class ProductFactory {
  ...
  */
  ...
  static async createProduct(type, payload) {
    const product_class = this.productRegistry[type];

    if (!product_class)
      throw new BadRequestError(`Invalid Product Class :${product_class}`);
  ...
  static async updateProduct(type, productId, payload) {
    ...
    return new product_class(payload).updateProduct(productId);
  }
}
